...
task:
  ...
  description: Extend the shared audio layer to support simple generated sound effects and low-volume continuous ambient cues through the existing audio abstraction, with a Raylib-backed implementation suitable for RiverRun and future games.
  ...
  acceptance_criteria:
    - Application code triggers simple generated SFX by semantic identifier without calling Raylib directly
    - Application code starts and stops continuous ambient cues and adjusts their spatial position or mix through the abstraction boundary
